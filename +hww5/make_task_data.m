function results = make_task_data(varargin)
...
for i = 1:numel(task_ids)
  ...
  hww5.apply_inputs_outputs( runner, 'unified', 'task_data', task_id, params.config );

  tmp_results = runner.run( @hww5.make.task_data, task_id );
