function results = make_stimuli_setup(varargin)
...
for i = 1:numel(task_ids)
  ...
  hww5.apply_inputs_outputs( runner, 'unified', 'stimuli_setup', task_id, params.config );

  tmp_results = runner.run( @hww5.make.stimuli_setup, task_id );
