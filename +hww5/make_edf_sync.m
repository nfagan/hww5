function results = make_edf_sync(varargin)
...
for i = 1:numel(task_ids)
  ...
  hww5.apply_inputs_outputs( runner, {'unified', 'edf'}, 'edf_sync', task_id, params.config );
  
  tmp_results = runner.run( @hww5.make.edf_sync, task_id );
